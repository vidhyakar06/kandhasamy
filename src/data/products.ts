...
export const products: Product[] = [
  {
    ...
    price: 44.99,
    description: 'A timeless stack of classic heritage checkered towels. Expertly handloomed from 100% organic cotton, these towels feature exceptional absorbency, quick-drying performance, and a soft traditional texture. The collection includes red, orange, yellow, and blue checks.',
    category: 'Bath',
    images: [
    ...
    colors: ['Red Checks', 'Orange Checks', 'Yellow Checks', 'Blue Checks'],
  ...
  {
    id: '22',
    name: 'Kandhasamy Textile Harvest & Earth Checked Towels Set',
    price: 34.99,
    description: 'An elegant set of duo-tone checkered towels in warm harvest yellow and deep terracotta-blue checks. Handloomed from pure organic cotton, offering premium absorbency, durability, and a lightweight feel.',
    category: 'Bath',
    images: [
    ...
    angleLabels: [
      'Folded Duo Stack',
      'Terracotta & Yellow Folded',
      'Harvest Yellow Rolled',
    ],
    colors: ['Harvest Yellow Checks', 'Terracotta & Blue Checks'],
    sizes: ['Single (30" x 60")', 'Double (60" x 90")'],
